...
public class Aims {
    ...
    public static void showMenu(){
        ...
        switch (option) {
            ...
            case 3:
                ...
                break;
            case 0:
                System.out.println("You are exxitted.");
                break;
        }
    }
    //Option 1
        ...
        switch (option) {
            ...
            case 2:
                if(media instanceof CompactDisc){
                    ...
                    System.out.println("This madia can not display.");
                    mediaDetailMenu(media);
                }
            case 0:
                break;
        }
    ...
    public static void addMediaToStore(){
        ...
        switch (option) {
            case 1:
                ...
                @SuppressWarnings("unused") int id = scanner.nextInt();
                System.out.println("Enter title of media: ");
                String title = scanner.nextLine();
    ...
    public static void removeMedia(){
        ...
        if(media==null) System.out.println("Can not find media");
    ...
    public static void playMediaCart(){
        ...
        if(media1==null) System.out.println("Can not find media");
